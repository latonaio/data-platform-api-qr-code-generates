...
import (
	dpfm_api_caller "data-platform-api-barcode-generates/DPFM_API_Caller"
...
func callProcess(
	...
	res, _ := caller.AsyncBarcodeGenerates(&input, &output, l, &errs, conf)
	if len(errs) != 0 {
